...
if(paddle.pos.y+paddle.height>=canvas.height){
 ...
 function bumbugHanamurguh(ball){
...
function onooNemeh(ball, paddle1, paddle2){
...
// ballY +=ballVelocityY;
ball.update()
bumbugHanamurguh(ball);
paddle1.update();
tsohiurTsohih(paddle1);
holboos(ball, paddle1);
holboos(ball, paddle2);
player2AI(ball, paddle2);
onooNemeh(ball, paddle1, paddle2)
drawGameScene()
// paddle2.update();
 }
